...
/* 
  ...
  - sm: Tablets/Small Laptops (>= 640px)
  - md: Laptops (>= 768px)
  - lg: Desktops (>= 1024px)
...
/*
  Guidelines:
  1. Use WebP for all static images
  2. Use AVIF where supported
  3. Compress videos and use web-optimized formats (WebM/VP9 preferred, fallback to H.264)
