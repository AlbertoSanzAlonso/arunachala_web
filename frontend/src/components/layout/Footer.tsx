        ...
        <footer className="bg-[#5c6b3c] text-[#F5F5DC] font-light transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                ...
                <div className="md:col-span-1 flex flex-col gap-6 text-center items-center">
                    <h3 className="text-2xl font-headers tracking-widest text-[#F5F5DC] font-bold">ARUṆĀCHALA</h3>
                ...
                <div className="col-span-1 flex flex-col gap-6 items-center text-center lg:h-full lg:justify-between">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://open.spotify.com/playlist/6VcF2kTyuuqt0rm91BYRll?si=P0Hla-TITFSXCLYYDWb0oA&pi=0rDSpo_XT96N6" target="_blank" rel="noopener noreferrer" aria-label={t('footer.labels.spotify')} className="text-[#F5F5DC]/80 hover:text-[#becf81] hover:scale-110 transition-all duration-300">
            ...
            <div className="w-full bg-black/20 py-6 text-center border-t border-[#F5F5DC]/10">
                <p className="text-xs text-[#F5F5DC]/40 uppercase tracking-widest">
                    &copy; {new Date().getFullYear()} Aruṇāchala Web. {t('footer.rights')}
                </p>
            </div>
        </footer>
    );
