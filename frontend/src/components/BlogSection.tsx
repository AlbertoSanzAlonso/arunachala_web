                    ...
                    <div className="relative group/slider">
                        <div className="relative flex items-center">
                            ...
                            <div
                                ...
                                className={`flex gap-4 md:gap-6 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-8 pt-4 px-[10vw] md:px-1 w-full ${isSlider ? '' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'}`}
                            ...
                            >
                                {articles.map((article, index) => (
                                    <motion.article
                                        ...
                                        className={`flex-none w-[80vw] md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] snap-center snap-always bg-white rounded-[2rem] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 cursor-pointer group`}
                                    >
