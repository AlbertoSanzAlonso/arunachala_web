                    ...
                    <div className="relative group/slider">
                        <div className="relative flex items-center">
                            ...
                            <div
                                ...
                                className="flex gap-4 md:gap-6 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-12 pt-4 px-[10vw] md:px-1 w-full"
                            ...
                            >
                                {news.map((item, idx) => (
                                    <motion.article
                                        ...
                                        className="flex-none w-[80vw] md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] snap-center snap-always bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 cursor-pointer group flex flex-col h-full border border-white"
                                    >
