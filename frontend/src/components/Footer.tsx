            ...
            <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div className="col-span-1 flex flex-col gap-4 text-center md:text-left">
                    ...
                    <ul className="flex flex-col gap-3 text-sm text-bone/70">
                        ...
                        <li><Link to="/therapies" onClick={() => window.scrollTo(0, 0)} className="hover:text-bone hover:translate-x-1 transition-all inline-block">Terapias & Masajes</Link></li>
                ...
                <div className="col-span-1 flex flex-col gap-6 items-center md:items-start text-center md:text-left">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-bone/70 hover:text-matcha hover:scale-110 transition-all duration-300">
                            <YoutubeIcon className="w-6 h-6" />
                        </a>
                        <a href="https://spotify.com" target="_blank" rel="noopener noreferrer" className="text-bone/70 hover:text-matcha hover:scale-110 transition-all duration-300">
