...
const navigation = [
    ...
    { name: 'Tarifas y Promociones', href: '/dashboard/promotions', icon: TicketIcon },
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
                        <div className="flex flex-col shrink-0 items-center mt-6 mb-1">
                            <img src={logoIcon} alt="Aruṇāchala Icon" className="h-24 w-auto mb-1 rounded-full" />
                            <h1 className="text-xl font-bold text-primary-600 tracking-tight font-headers">Aruṇāchala<span className="text-gray-400 font-light">Panel</span></h1>
                        </div>
                        <nav className="flex flex-1 flex-col">
                            <ul className="flex flex-1 flex-col gap-y-7">
                                <li>
