...
const BlogCategoryPage: React.FC = () => {
    ...
    return (
        <div className="font-body text-bark min-h-screen flex flex-col relative bg-bone">
            <PageSEO
                title={`${getCategoryTitle()} | Arunachala Yoga`}
                description={getCategorySubtitle()}
            />
                ...
                <div className="max-w-7xl mx-auto px-6 relative w-full">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <motion.h1
                            ...
                            className="text-4xl md:text-6xl font-headers text-forest mb-4 uppercase tracking-wider pt-0"
                        >
                            {getCategoryTitle()}
                        </motion.h1>
                        <motion.p
