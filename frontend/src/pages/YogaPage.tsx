...
const YogaPage: React.FC = () => {
    ...
    return (
        <div id="yoga-scroll-container" ref={containerRef} className="font-body text-bark h-screen overflow-y-auto flex flex-col relative scroll-smooth">
            <PageSEO
            ...
            <main className="flex-grow bg-bone">
                <div id="top" className="relative w-full min-h-[85vh] md:min-h-[90vh] flex items-center justify-center" role="banner">
                    <div
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-7xl mx-auto w-full py-12">
                        <motion.h1
                            ...
                            className="text-6xl md:text-9xl font-headers text-white mb-6 md:mb-8 tracking-wide drop-shadow-lg mt-0"
                        >
                            {t('yoga.title')}
                        </motion.h1>
