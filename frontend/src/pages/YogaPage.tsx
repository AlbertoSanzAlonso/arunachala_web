    ...
    return (
        <div ref={containerRef} className="font-body text-bark h-screen overflow-y-auto flex flex-col relative snap-y snap-proximity scroll-smooth">
            ...
            <main className="flex-grow bg-bone">
                <div id="top" className="relative w-full min-h-[100vh] md:min-h-[90vh] flex items-center justify-center snap-start" role="banner">
                ...
                <section ref={galleryRef} className="w-full max-w-7xl mx-auto px-4 md:px-6 py-32 md:py-48 scroll-mt-24 snap-start">
                    <FadeInSection>
