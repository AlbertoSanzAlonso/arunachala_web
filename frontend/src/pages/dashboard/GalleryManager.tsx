    ...
    return (
        ...
        >
            ...
            <div className="mt-6 border-b border-gray-200">
                <nav className="mobile-tabs-container custom-scrollbar -mb-px flex space-x-6 sm:space-x-8 overflow-x-auto" aria-label="Tabs">
            ...
            <ConfirmModal
                isOpen={imageToDelete !== null || isBulkDeleting}
                onClose={() => {
                    setImageToDelete(null);
                    setIsBulkDeleting(false);
                }}
            ...
            {croppingImage && (
                <CropModal
                    ...
                    aspectRatio={
                        selectedCategory === 'yoga' || selectedCategory === 'therapies'
                            ? 16 / 9
