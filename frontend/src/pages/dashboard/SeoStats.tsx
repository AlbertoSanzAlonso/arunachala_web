    ...
    return (
        <div>
            ...
            <div className="bg-white shadow rounded-lg p-8 text-center border border-gray-200 max-w-2xl mx-auto">
                ...
                />
                <h2 className="text-xl font-bold text-gray-900 mb-2">Conectar con Google</h2>
                <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                    Para ver tus estadísticas de búsqueda, posiciones de palabras clave y tráfico, necesitas conectar tu cuenta de Google Search Console y Analytics.
                </p>
