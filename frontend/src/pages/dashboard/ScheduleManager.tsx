    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error instanceof TypeError && error.message === 'Failed to fetch') {
                setError('Error de conexión o CORS. Por favor, verifica tu conexión y sesión.');
            } else {
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    <p className="text-sm font-semibold text-gray-900">
                                                        ...
                                                        {schedule.yoga_class?.age_range ? ` (${schedule.yoga_class.age_range})` : ''}
                                                    </p>
                                                ...
                                                <div className="mt-1 flex items-center gap-4 text-sm text-gray-500">
                                                    ...
                                                    {schedule.note && (
                                                        <span className="italic text-gray-400 text-xs truncate max-w-[200px]">{schedule.note}</span>
                                                    )}
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                        ...
                        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-5">
                                ...
                                >
                                    ...
                                    {yogaClasses.map(yc => (
                                        <option key={yc.id} value={yc.id}>
                                            {yc.name}{yc.age_range ? ` (${yc.age_range})` : ''}
                                        </option>
                                    ))}
                                </select>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="relative mt-1">
                                        ...
                                        >
                                            <ClockIcon className="h-5 w-5 text-gray-400 hover:text-primary-600 transition-colors" />
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border"
                                    placeholder="Ej: Con cita previa, Nivel avanzado..."
                                />
                                <p className="mt-1 text-xs text-gray-400 italic">Se traducirá automáticamente a CA y EN.</p>
                            </div>
